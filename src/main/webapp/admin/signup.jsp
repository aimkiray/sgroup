...
<form action="/" name="login" class="login-content">
<table class="login-table">
    <tr>
        <td class="title" colspan="5">美国圣地亚戈国际集团の某不为人知的交易界面</td>
    </tr>
    <tr>
        <td class="login-text"><span style="color: red;">*</span>君の名は:</td>
        <td colspan="2"><input type="text" onblur="checkRegular(this,1)"></td>
        <td colspan="2" class="login-prompt"><span style="color: #00FFFF">&nbsp;你的名字。</span></td>
    </tr>
    <tr>
        <td class="login-text">邮箱：</td>
        <td colspan="2">
            <input type="text" onblur="checkRegular(this,2)" id="inputMail">
        </td>
    ...
    <tr>
        ...
        <td colspan="2"><input type="text" onblur="checkRegular(this,4)"></td>
        <td colspan="2" class="login-prompt"></td>
    </tr>
    <tr>
