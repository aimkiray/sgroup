package com.sgroup.servlet;

import com.alibaba.fastjson.JSON;
import com.sgroup.entity.Product;
import com.sgroup.entity.ProductType;
import com.sgroup.service.ProductService;
import com.sgroup.service.ProductTypeService;
import com.sgroup.service.serviceImplement.ProductServiceImpl;
import com.sgroup.service.serviceImplement.ProductTypeServiceImpl;
import com.sgroup.utils.BootstrapTable;
import com.sgroup.utils.DataTables;
import com.sgroup.utils.DateTools;
 ...
 */
public class BootstrapProductServlet extends HttpServlet {
...
//    private String charset = "";
    ...
    public BootstrapProductServlet() {
        super();
//    新建产品类别和产品の实现类
...
//        由于提交了全部表单，需要判断修改哪个
        int productId = Integer.parseInt(values.get("productId").toString());
        String productName = values.get("productName").toString();
        int productPrice = Integer.parseInt(values.get("productPrice").toString());
        int number = Integer.parseInt(values.get("number").toString());
        int productTypeId = Integer.parseInt(values.get("productTypeId").toString());
        String productTime = values.get("productTime").toString();
        String picName = values.get("uploadPic").toString();
//    通过typeId获得Type对象
        ProductType productType = productTypeService.queryTypeByTypeId(productTypeId);
//    获取当前时间
